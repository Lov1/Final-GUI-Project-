...
Date: Nov.23, 2017
File: index.php
Description: this file is the interface of our version 1 project
-->
...
<html>
    ...
    <div class = "picture1">
        <div id="test" class="jumbotron text-center">
            <h2 id =header1  aria-describedby="header_help">
                Declaration of Intent to Graduate
            </h2>
            <small id="header_help" class="form-text text-muted">
                For Computer Science students  (with course database imported)
            </small>
        </div>
    </div>
